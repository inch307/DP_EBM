...
def write_columns(wr):
    ...
    wr.writerow(['data', 'n_runs', 'privacy', 'eps', 'delta', 'af', 'af_prob', 'min_cf', 'lr', 'epo', 'rmse', 'rmse_std', 'acc', 'acc_std', 'auroc', 'auroc_std', 'actual_eps'])

def make_write_lst(args):
    lst = [args.data_path, args.n_runs, args.privacy, args.eps, args.delta, args.adaptive_feature, args.af_prob, args.min_cf, args.lr, args.epochs]
