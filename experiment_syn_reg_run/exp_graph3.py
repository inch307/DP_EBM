...
# task cls delta 0
if args.task == 'cls' and args.delta == 0:
    start_eps1 = original_eps_lst.index(0.02)
    start_eps2 = original_eps_lst.index(0.1)
    start_eps3 = original_eps_lst.index(1)
# task cls delta 0

# task cls delta 1e-6
elif args.task == 'cls' and args.delta == 1e-6:
    start_eps1 = original_eps_lst.index(0.002)
    start_eps2 = original_eps_lst.index(0.01)
    start_eps3 = original_eps_lst.index(0.02)
# task cls delta 1e-6

# task reg delta 0
elif args.task == 'reg' and args.delta == 0:
    start_eps1 = original_eps_lst.index(0.1)
    start_eps2 = original_eps_lst.index(0.1)
    start_eps3 = original_eps_lst.index(1)
# task reg delta 0

# task reg delta 1e-6
elif args.task == 'reg' and args.delta == 1e-6:
    start_eps1 = original_eps_lst.index(0.01)
    start_eps2 = original_eps_lst.index(0.002)
    start_eps3 = original_eps_lst.index(0.1)
# task reg delta 1e-6
...
# af_prob1 = [0.5, 0.5, 0.5, 0.5, 0.002, 0.001, 0.001]
# af_prob2 = [0.5, 0.5, 0.5, 0.5, 0.001, 0.001, 0.001]
# af_prob3 = [0.5, 0.5, 0.1, 0.1, 0.005, 0.005, 0.001]
########################################### Modify here ###############################################
